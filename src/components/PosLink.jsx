...
const PosLink = ({ isOpen, name, onClick, children, href }) => {
  const classes = `flex items-center font-semibold rounded cursor-pointer hover:-translate-x-2 transition-transform duration-300 stroke-[0.75] hover:bg-[#4CBB17] text-sm ${
