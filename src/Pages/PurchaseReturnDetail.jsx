...
const PurchaseReturnDetail = () => {
  ...
  // Pagination logic without filtering
  ...
  return (
    <div className={`mt-8 p-10 ${theme === "dark" ? "bg-dark-50" : "bg-light-50"}`}>
      ...
      >
        <h2 className="text-2xl font-bold">{supplier?.name || "Unknown Supplier"}</h2>
        <p className="text-sm">{supplier?.address || "No address available"}</p>
      ...
      <div className="flex justify-between mt-5 px-5">
        ...
        >
          ...
          <p><b>Phone:</b> {supplier?.contact || "N/A"}</p>
        ...
        >
          ...
          <p><b>SalesMan:</b> {supplier?.name || "N/A"}</p>
        </div>
      </div>
            ...
            >
              ...
              <tbody className="text-[10px]">
                {paginatedProducts.map((item, idx) => {
                  const productName =
                    item.pharmacyProduct?.medicine?.brandName || "Unknown";
                  const productType =
                    item.pharmacyProduct?.packaging?.packageType || "N/A";
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-2">{productType}</td>
                      <td className="px-4 py-2 text-warning-50 font-extrabold">
                        {item.quantity}
                      </td>
                ...
                >
                  <td colSpan={6} className="px-4 py-2 text-sm font-medium text-right">
                    Total
                  </td>
